...
const GsapScrollTrigger = () => {
  ...
  useGSAP(() => {
    const boxes = gsap.utils.toArray(scrollRef.current.children);     // how to get the children using react ref
  ...
  }, {scope: scrollRef}); // scope: scrollRef is used to know when the animation should be triggered
